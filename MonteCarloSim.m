...
%loads the nominal trajectory and the maneuver generating trajectory scenario
loadScen(root, path1)
loadScen(root2, path2)

% nominal satellite Name here
satName = 'CurrentNom';
...
%%
root2.ExecuteCommand(sprintf('Astrogator */Satellite/%s SetValue MainSequence.SegmentList.Targeter.SegmentList.Maneuver.StoppingConditions.Duration.TripValue 10 sec', 'MnvrCalc'));


%%
clc
a = root2.ExecuteCommand(sprintf('Astrogator_RM */Satellite/%s GetValue MainSequence.SegmentList.Targeter.SegmentList.Maneuver.StoppingConditions.Duration.TripValue', 'MnvrCalc'));
